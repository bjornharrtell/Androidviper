...
public class RobustLineIntersector extends LineIntersector {
	...
	protected int computeIntersect(Coordinate p1, Coordinate p2, Coordinate q1,
		...
		if (Pq1 == 0 || Pq2 == 0 || Qp1 == 0 || Qp2 == 0) {
			...
			/**
			 * Check for two equal endpoints. This is done explicitly rather
			 * than by the orientation tests below in order to improve
			 * robustness.
			 * 
			 * [An example where the orientation tests fail to be consistent is
			 * the following (where the true intersection is at the shared
			 * endpoint POINT (19.850257749638203 46.29709338043669)
			 * 
			 * LINESTRING ( 19.850257749638203 46.29709338043669,
			 * 20.31970698357233 46.76654261437082 ) and LINESTRING (
	...
	private Coordinate intersection(Coordinate p1, Coordinate p2,
		 ...
		 * outside the envelopes of the input segments. Clearly this is
		 * inconsistent. This code checks this condition and forces a more
		 * reasonable answer
		 * 
	...
	private Coordinate intersectionWithNormalization(Coordinate p1,
			Coordinate p2, Coordinate q1, Coordinate q2) {
	 ...
	 */
	private Coordinate safeHCoordinateIntersection(Coordinate p1,
			Coordinate p2, Coordinate q1, Coordinate q2) {
