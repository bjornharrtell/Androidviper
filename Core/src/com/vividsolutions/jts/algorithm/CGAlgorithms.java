...
public class CGAlgorithms {
	...
	public static double distanceLineLine(Coordinate A, Coordinate B,
		 ...
		 * limiting conditions: If 0<=r<=1 & 0<=s<=1, intersection exists r<0 or
		 * r>1 or s<0 or s>1 line segments do not intersect If the denominator
		 * in eqn 1 is zero, AB & CD are parallel If the numerator in eqn 1 is
		 * also zero, AB & CD are collinear.
		 */
